...
namespace xfile
{
	public class XFileConverter
	{
		...
		public UnityEngine.Object CreatePrefab()
		{
			...
			var gameObject = new GameObject("__XFileConverter_Holder__");
			return PrefabUtility.SaveAsPrefabAsset(contentsRoot, path);
		}
		...
		public void ReplacePrefab(UnityEngine.Object prefab, Mesh mesh, UnityEngine.Material[] materials)
		{
			...
			PrefabUtility.SaveAsPrefabAsset(obj, AssetDatabase.GetAssetPath(prefab));
